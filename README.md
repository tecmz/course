...
魔众课程报名系统可为专为教育培训机构设计的在线选课报名系统，学员可综合考虑课程分类、适合人群、上课地点、上课时间、课程价格等多种选报最合适的班级
...
- [系统优化] 课程报名系统视频直播课程图文课程后台Dashboard布局优化
...
- [系统优化] 后台界面显示优化升级
- [系统优化] 优化弹窗重复导入的异常问题
- [系统优化] 文档内容页面下载操作区域功能调整
- [系统优化] 表格无数据时内容优化（增加图标）
- [Bug修复] 文件选择弹窗自定义输入链接不生效问题
- [Bug修复] 后台课程管理详细信息查看问题
- [Bug修复] 课程报名自定义字段判断逻辑异常
- [Bug修复] 课程显示隐藏部分位置失效
